...
# Optional text substitution for emojis to make speech more expressive
EMOJI_TEXT = {
    "😂": " *giggles* ",
    "😄": " *smiles happily* ",
    "😊": " *blushes* ",
...
def _speak_thread(text: str, with_video: bool, expression: str = None):
    ...
    # Clean and convert emojis to SSML-friendly text
    clean = re.sub(r"[*_`~^]", "", text)  # remove markdown
    clean = re.sub(r"[\"“”]", "", clean)  # remove smart quotes
